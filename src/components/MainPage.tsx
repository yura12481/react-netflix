            ...
            <Box margin="-8% 0 -4% -6%" position="relative">
              ...
              >
                ...
                <Box className="card-animation-text" marginRight="35%">
                  <Box fontSize="1em" fontWeight="500">
                    Stranger Things
                  </Box>
                  <Box fontSize=".9em" fontWeight="400" color="#0071eb">
                    Downloading...
                  </Box>
                </Box>
                <Box className="card-animation-icon">
                  <HourglassBottomIcon />
                </Box>
              </Box>
            </Box>
          ...
          {AccordionArray.map((item) => (
            <Accordion
              ...
              onChange={(event, isExpanded) =>
                handleChange(isExpanded, `${item.expanded}`)
              }
            >
              <AccordionSummary
                sx={{ height: '75px', borderBottom: '1px solid black' }}
              ...
              >
                <Typography fontWeight="400" fontSize="26px">
                  {item.title}
                </Typography>
              </AccordionSummary>
