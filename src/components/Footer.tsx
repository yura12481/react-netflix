...
import { List, ListItem, ListItemText, Box, Link, Typography, FormControl, Select, MenuItem } from '@mui/material';
...
const Footer = () => {
  ...
  return (
    <Box sx={{ padding: '70px 45px 12px 45px', fontSize: '13px', color: '#737373', backgroundColor: '#000' }}>
      <Box sx={{ maxWidth: '1000px', margin: '0 auto', width: '90%' }}>
        <Typography component='p'
