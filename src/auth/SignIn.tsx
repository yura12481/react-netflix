...
import { FormModel, ResponseApi, YupValidation } from '../modules/modules';
...
const SignIn: React.FC = () => {
  let [toogleBtn, setToogleBtn] = useState<boolean>(true);
  ...
  const formik = useFormik<FormModel>({
    ...
    onSubmit: () => {
      axios
        .post<ResponseApi>('https://reqres.in/api/login', {
